...
const STARTERS = [
  ...
  },
  {
    ...
    isStarter: true,
    priceCredits: 0,
    description: "The chill one with the funny observations",
    personality: "The Chill One — laid back, funny observations, never stressed",
  ...
  },
  {
    ...
    isStarter: true,
    priceCredits: 0,
    description: "The hype bro who never stops cheering",
    personality: "The Hype Bro — fist bumps, 'LET'S GO!' energy, maximum volume",
