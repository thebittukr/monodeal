...
const BOT_POOL = [
  { name: "Jake_TX",     country: "US", avatar: 87, personality: "aggressive" },
  { name: "MiaBee",      country: "US", avatar: 18, personality: "strategic" },
  { name: "NYCQueen",    country: "US", avatar: 42, personality: "aggressive" },
  { name: "ChicagoColt", country: "US", avatar: 55, personality: "balanced" },
  { name: "ArjunAce",    country: "IN", avatar: 6,  personality: "strategic" },
  { name: "PriyaWins",   country: "IN", avatar: 51, personality: "balanced" },
  { name: "RohitKing",   country: "IN", avatar: 33, personality: "aggressive" },
  { name: "LucasBR",     country: "BR", avatar: 71, personality: "aggressive" },
  { name: "GabiCards",   country: "BR", avatar: 39, personality: "balanced" },
  { name: "BrunaAce",    country: "BR", avatar: 82, personality: "strategic" },
  { name: "SophieLDN",   country: "GB", avatar: 66, personality: "balanced" },
  { name: "JackCards",   country: "GB", avatar: 28, personality: "aggressive" },
  { name: "PutriGO",     country: "ID", avatar: 22, personality: "strategic" },
  { name: "RizkyPro",    country: "ID", avatar: 12, personality: "balanced" },
  { name: "CarlosMX",    country: "MX", avatar: 77, personality: "aggressive" },
  { name: "ValeriaRush", country: "MX", avatar: 48, personality: "strategic" },
  { name: "YukiJP",      country: "JP", avatar: 91, personality: "strategic" },
  { name: "EmreCards",   country: "TR", avatar: 44, personality: "aggressive" },
  { name: "MaxBerlin",   country: "DE", avatar: 63, personality: "strategic" },
  { name: "ChimaNG",     country: "NG", avatar: 15, personality: "aggressive" },
  { name: "MinhoKR",     country: "KR", avatar: 34, personality: "strategic" },
  { name: "AnyaSPB",     country: "RU", avatar: 59, personality: "aggressive" },
  { name: "JanellaAce",  country: "PH", avatar: 26, personality: "strategic" },
  { name: "MarcPH",      country: "PH", avatar: 73, personality: "aggressive" },
  { name: "SakuraOSK",   country: "JP", avatar: 45, personality: "aggressive" },
  { name: "OmarEG",      country: "EG", avatar: 88, personality: "aggressive" },
  { name: "LinaVN",      country: "VN", avatar: 31, personality: "strategic" },
  { name: "SofiaAR",     country: "AR", avatar: 67, personality: "unpredictable" },
  { name: "CanIST",      country: "TR", avatar: 19, personality: "strategic" },
  { name: "HannahMUC",   country: "DE", avatar: 53, personality: "aggressive" },
];
...
export function makeBot(botDef) {
  ...
  const flag = _flag(botDef.country);
  return {
    id,
    name: `${flag} ${botDef.name}`,
    hand: [],
    assets: {},
    bank: [],
    isBot: true,
